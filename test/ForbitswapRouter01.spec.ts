...
enum RouterVersion {
  ForbitswapRouter01 = 'ForbitswapRouter01',
  ForbitswapRouter02 = 'ForbitswapRouter02'
}

describe.skip('ForbitswapRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.ForbitswapRouter01]: fixture.router01,
        [RouterVersion.ForbitswapRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.ForbitswapRouter01]: 101876,
              [RouterVersion.ForbitswapRouter02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.ForbitswapRouter01]: 138770,
              [RouterVersion.ForbitswapRouter02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
